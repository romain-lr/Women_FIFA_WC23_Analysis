...
## Analysis of successfull shots according to country
...
```{r fig1 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fig1}Diagram of the number of goals and shots in all matches for each team",fig.height=2.5}
#Let's make a graph
...
```{r fig2 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fig2}Diagram of the percentage of shots leading to a goal",fig.height=2,fig.align='center'}
...
## Analysis of successfull shots according to different variables  

### According to type of shots
...
### According to technique of shots
