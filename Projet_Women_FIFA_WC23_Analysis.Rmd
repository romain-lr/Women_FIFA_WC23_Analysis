...
```{r fig8 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fi8}Goal ratio on the Expected Goal ratio (Statsbomb model) for players",fig.height=2,fig.align='center'}
ggplot(df2_player, aes(xG_ratio, shots_completion_ratio, size = total_shots, label = player, colour=groupv2)) + 
...
```{r fig9 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fi9}Goal ratio on the number of total shots for teams",fig.height=2,fig.align='center'}
...
```{r fig10 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fi10}Goal ratio on the Expected Goal ratio (Statsbomb model) for teams",fig.height=2,fig.align='center'}
...
```{r fig11 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fi11}StatsBomb xG ratio on our xG ratio based on bestmod for players",fig.height=2,fig.align='center'}
...
```{r fig12 ,echo=F,eval=TRUE,fig.cap="\\label{fig:fi12}StatsBomb xG ratio on our xG ratio based on bestmod for teams",fig.height=2,fig.align='center'}
